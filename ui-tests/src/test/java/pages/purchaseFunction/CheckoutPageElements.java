...
public class CheckoutPageElements {
    public static final String CHECKOUT_PAGE_TITLE = "//a[@class='current']";
    public static final String CHECKOUT_DETAILS_HEADER = "//h3[contains(., 'Rechnungsdetails')]";
    ...
    public static final String REQUIRED_CHECKBOX_LEGAL_ALERT = "//li[@data-id='legal']";
